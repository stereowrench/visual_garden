defmodule VisualGardenWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(VisualGardenWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(VisualGardenWeb.Gettext, "errors", msg, opts)
    end
  end
